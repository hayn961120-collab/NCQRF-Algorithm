...
from ..utils._random cimport RAND_R_MAX, rand_int, rand_uniform
...
cdef inline int node_split_best(
    ...
    while (f_i > n_total_constants and  # Stop early if remaining features
        ...
        criterion.precompute_split_losses(end_non_missing)
    ...
    if best_split.pos < end:
        ...
        criterion.precompute_split_losses(end - best_split.n_missing)
